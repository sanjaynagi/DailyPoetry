### Project management
	•	For any significant work create a plan.md and discuss this with the user to achieve alignment before starting work. This should include a clear definition of the problem, proposed solution, and success criteria.
